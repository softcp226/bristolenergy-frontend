const handle_updateuser = async (form) => {
  ...
  try {
    const response = await fetch(
      "https://bristolenergy.glitch.me/api/user/update",
      {
        method: "POST",
...
const updatepassword = async (form) => {
  ...
  try {
    const response = await fetch(
      "https://bristolenergy.glitch.me/api/user/update/update_password",
      {
        method: "POST",
        headers: { "content-type": "application/json" },
        body: JSON.stringify(form),
...
(async () => {
  ...
  try {
    const response = await fetch(
      "https://bristolenergy.glitch.me/api/user/fetch",
      {
        method: "POST",
        headers: { "content-type": "application/json" },
