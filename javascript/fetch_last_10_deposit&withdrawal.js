...
// 									<div class="pr_box">
// 										<h6>Ahmadi</h6>
// 										<div class="withdrawal-detail-c">
// 											<div>
// 												<p>$91,000</p>
// 											</div>
// 											<div><img src="css/dep-with-image/btc.gif" alt=""></div>
// 											<div>
// 												<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48"
// 													fill="red" class="bi bi-caret-down-fill" viewBox="0 0 16 16">
// 													<path
...
const fetch_first_10_deposits = async () => {
  try {
    const response = await fetch(
      ...
      "https://bristolenergy.glitch.me/last_10_withdrawals&deposit/last_10_deposits",
    );
    ...
    console.log("the error occured here", error.message);
    alert(error.message);
  }
};
...
const fetch_first_10_withdrawals = async () => {
  try {
    const response = await fetch(
      "https://bristolenergy.glitch.me/last_10_withdrawals&deposit/last_10_withdrawals",
