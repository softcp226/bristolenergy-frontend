...
const delete_proccessing = async (data) => {
  ...
  try {
    const response = await fetch(
      ...
      "https://bristolenergy.glitch.me/api/admin/payment_proccessing/delete",
      {
        method: "DELETE",
...
const create_element = (data) => {
  ...
  delete_btn_a.onclick = () =>
    delete_proccessing({ delete_btn_a, payment_proccessor_ID:data._id });
...
(async () => {
  ...
  try {
    const response = await fetch(
      "https://bristolenergy.glitch.me/api/admin/payment_proccessing/fetch",
