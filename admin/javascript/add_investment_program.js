...
const edit_investment_program = async (data) => {
  ...
  try {
    const response = await fetch(
      "https://bristolenergy.glitch.me/api/admin/investment_packages/edit",
...
const add_investment_program = async (data) => {
  ...
  try {
    const response = await fetch(
      "https://bristolenergy.glitch.me/api/admin/investment_packages/add",
...
(async () => {
  ...
  try {
    const response = await fetch(
      "https://bristolenergy.glitch.me/api/admin/investment_packages/fetch",
